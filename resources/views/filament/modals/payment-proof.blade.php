    ...
    <div class="grid grid-cols-2 gap-4 p-4 bg-gray-50 rounded-lg">
        <div>
            ...
            <p class="font-semibold">
                @if($record->payment_method === 'cash') 💵 Bayar di Tempat
                @elseif($record->payment_method === 'bank_transfer') 🏦 Transfer Bank
                @elseif($record->payment_method === 'qris') 📱 QRIS
                @elseif($record->payment_method === 'e_wallet') 💳 E-Wallet
                @else - @endif
            </p>
        </div>
